...
static const char* module_data[] = {OBS_INSTALL_DATA_PATH "/obs-plugins/%module%", OBS_DATA_PATH "/obs-plugins/%module%",
...
static void log_memory_info(void)
{
    ...
    blog(LOG_INFO, "Physical Memory: %" PRIu64 "MB Total, %" PRIu64 "MB Free", (uint64_t)info.totalram * info.mem_unit / 1024 / 1024,
